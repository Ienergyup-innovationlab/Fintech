...
const FarmTech = () => {
  return (
    <div className="w-[1440px] h-[1024px] font-poppins flex justify-center">
      <div className="w-auto h-auto  flex justify-center  bg-white">
        <div className=" flex w-full justify-center relative space-y-10 ml-[500px] ">
          <p className="mt-[43px] text-3xl font-bold mr-10 absolute">Farmtech</p>
          <Button
            url="/EditPage"
            variant=" mt-[43px] py-3 px-2 text-xl text-center absolute ml-[1000px]   w-20 h-14 text-white"
            text="Edit"
          />

          {/* <p className="ml-[317px] mt-[43px] underline ">Schedule a meeting</p> */}
        </div>
        <div className="w-[182px] h-[182px] top-[117px] left-[817px] absolute bg-white border border-neutral-400 rounded-full ">
