  ...
  return (
    <div className="w-full h-auto bg-white border border-none font-poppins relative">
      <div className="flex items-center justify-center">
        <h1 className="text-black font-bold text-2xl mt-[71px] items-center">
          Customer Satisfaction
        </h1>
        <h2 className=" mt-[180px] text-sm absolute  ">
      ...
      <div className="flex justify-center space-x-[108px] ">
        <h1 className="mt-10 hover:bg-violet-100 cursor-pointer hover:underline">
          Excellent
        </h1>
        <h1 className=" mt-10  hover:bg-violet-100 cursor-pointer hover:underline">
          Good
      ...
      <div className="flex relative justify-center">
        <h1 className="mt-20 text-xl mr-[900px]">
          Your Review
        </h1>
        <input
          type="text"
